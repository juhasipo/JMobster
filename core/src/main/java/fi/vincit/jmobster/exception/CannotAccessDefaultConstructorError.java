...
public class CannotAccessDefaultConstructorError extends RuntimeException {
    ...
    public CannotAccessDefaultConstructorError( String s ) {
        super( s );
    }

    public CannotAccessDefaultConstructorError( String s, Throwable throwable ) {
        super( s, throwable );
    }

    public CannotAccessDefaultConstructorError( Throwable throwable ) {
        super( throwable );
    }
}
